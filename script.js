...
const messageInput = document.getElementById('clientInput'); // Corrected the input ID
const outputDiv = document.getElementById('serverOutput'); // Use div as output now
